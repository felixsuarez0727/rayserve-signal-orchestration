...
def estimate_snr_per_chunk(chunks: np.ndarray) -> np.ndarray:
    power = np.sum(chunks * chunks, axis=2)
...
def main() -> None:
    ...
    parser.add_argument("--input_dir", type=str, default="data/raw/neu_bz61g073z")
    parser.add_argument("--output_dir", type=str, default="data/processed/spectrum")
